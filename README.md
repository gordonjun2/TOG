...
Please clone [keras-yolo3-MSTAR-detection](https://github.com/gordonjun2/keras-yolo3-MSTAR-detection) and put the folder together with TOG (beside, not inside).
...
```./TOG-MSTAR-detection/model_weights/yolov3-d/```.
